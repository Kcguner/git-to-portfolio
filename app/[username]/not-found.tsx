  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-16">
      ...
      <main className="card-premium relative z-10 mx-auto flex w-full max-w-xl flex-col items-center rounded-2xl p-8 text-center md:p-12">
        ...
        <span className="section-label mt-6">{dictionary.userLabel}</span>
        <h1 className="gradient-text mt-3 text-2xl font-bold tracking-tight md:text-3xl">{dictionary.userTitle}</h1>
        <p className="mt-3 text-sm leading-relaxed text-text-secondary">{dictionary.userDescription}</p>
